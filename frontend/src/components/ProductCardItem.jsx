...
const ProductCardItem = ({ product }) => {
    ...
    return (
        <div className='flex  w-full relative flex-col overflow-hidden rounded-lg border border-gray-700 shadow-lg'>
            <div className='relative mx-3 mt-3 flex h-fit sm:h-40 lg:h-60 overflow-hidden rounded-xl'>
            ...
            <div className='mt-4 px-5 pb-5 '>
                ...
                <div className='mt-2 mb-5 flex items-center justify-center '>
                    <p>
                        <span className='text-lg font-bold text-emerald-400  '>{product.price} VND</span>
                    </p>
                </div>
                <button
