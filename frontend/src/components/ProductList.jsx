...
const ProductList = () => {
  const { products, toggleFeature, deleteProduct } = useProductStore()
      ...
      <table className=' min-w-full divide-y divide-gray-700 '>
        <thead className='bg-gray-700 '>
          <tr className="">
            <th
              scope='col'
              className='text-left px-6 py-3 text-xs font-medium text-gray-300 uppercase tracking-wider'
            >
              Product
            </th>
            <th
        ...
        <tbody className='bg-gray-800 divide-y divide-gray-700 text-center'>
          {products?.map((product) => (
            <tr key={product._id} className='hover:bg-gray-700'>
              ...
              <td className='px-6 py-4 whitespace-nowrap'>
                <div className='text-sm text-gray-300'>{product.price} vnđ</div>
              </td>
              <td className='px-6 py-4 whitespace-nowrap'>
              ...
              <td className='px-6 py-4 whitespace-nowrap'>
                <button
                  onClick={() => toggleFeature(product._id)}
